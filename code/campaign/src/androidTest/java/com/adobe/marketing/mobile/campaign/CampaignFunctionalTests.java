...
public class CampaignFunctionalTests {
    ...
    public RuleChain rule =
            RuleChain.outerRule(new com.adobe.marketing.mobile.campaign.TestHelper.SetupCoreRule());

    // A test will be run at most 3 times
    @Rule public Retry totalTestCount = new Retry(3);
    ...
    public void setup() throws InterruptedException {
        ...
        ServiceProvider.getInstance()
                .getDataQueueService()
                .getDataQueue(CampaignConstants.EXTENSION_NAME)
                .clear();

        // set fake network service for testing
        ServiceProvider.getInstance().setNetworkService(testableNetworkService);

        TestHelper.setIdentityPersistence(
                TestHelper.createIdentityMap("ECID", "mockECID"),
                com.adobe.marketing.mobile.campaign.TestHelper.defaultApplication);
    ...
    public void tearDown() {
        ...
        ServiceProvider.getInstance()
                .getDataStoreService()
                .getNamedCollection(CAMPAIGN_DATASTORE)
                .removeAll();
        SDKHelper.resetSDK();
        cleanCache(TestHelper.defaultApplication.getApplicationContext());
    }

    private void setupProgrammaticConfig() throws InterruptedException {
        ...
        // ============================================================
        data.put(
                TestConstants.RULES_SERVER,
                "https://" + TestConstants.MOCK_RULES_SERVER + "/dummy-rules.zip");
        MobileCore.updateConfiguration(data);
        CountDownLatch configurationLatch = new CountDownLatch(1);
        configurationAwareness(
                configuration -> {
    ...
    private void setBuildEnvironment(final String buildEnvironment) {
        ...
        data.put(
                TestConstants.CAMPAIGN_SERVER,
                TestConstants.MOCK_CAMPAIGN_SERVER + "/" + buildEnvironment);
        MobileCore.updateConfiguration(data);
    ...
    private void updateTimestampInDatastore(final long timestamp) {
        ServiceProvider.getInstance()
                .getDataStoreService()
                .getNamedCollection(CAMPAIGN_DATASTORE)
                .setLong("CampaignRegistrationTimestamp", timestamp);
    }
    ...
    private void updateEcidInDatastore(final String ecid) {
        ServiceProvider.getInstance()
                .getDataStoreService()
                .getNamedCollection(CAMPAIGN_DATASTORE)
                .setString("ExperienceCloudId", ecid);
    }

    private void setRegistrationDelayOrRegistrationPaused(
    ...
    // Test Case No : 1
    @Test
    public void test_Functional_Campaign_profileUpdate_VerifyProfileUpdateOnLifecycleLaunch()
            throws InterruptedException {
        // setup
        final String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
        final String expectedUrl =
                "https://"
                        + TestConstants.MOCK_CAMPAIGN_SERVER
                        + "/rest/head/mobileAppV5/pkey/subscriptions/"
                        + experienceCloudId;
    ...
    @Test
    public void
            test_Functional_Campaign_profileUpdate_VerifyNoProfileUpdateOnLifecycleLaunchWhenPrivacyIsOptedOut()
                    throws InterruptedException {
        // setup
        final String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
        // two urls for the varying order of query parameters
        final String expectedUrl1 =
                "https://"
                        + TestConstants.MOCK_IDENTITY_SERVER
                        + "/demoptout.jpg?d_mid="
                        + experienceCloudId
                        + "&d_orgid=B1F855165B4C9EA50A495E06%40AdobeOrg";
        testableNetworkService.setNetworkResponse(expectedUrl1, "OK", 200);
        final String expectedUrl2 =
                "https://"
                        + TestConstants.MOCK_IDENTITY_SERVER
                        + "/demoptout.jpg?d_orgid=B1F855165B4C9EA50A495E06%40AdobeOrg&d_mid="
                        + experienceCloudId;
        testableNetworkService.setNetworkResponse(expectedUrl2, "OK", 200);
        // test
        MobileCore.setPrivacyStatus(MobilePrivacyStatus.OPT_OUT);
        // verify
        testableNetworkService.waitForRequest(expectedUrl1);
        testableNetworkService.waitForRequest(expectedUrl2);
        NetworkRequest optOutRequest1 = testableNetworkService.getRequest(expectedUrl1);
        NetworkRequest optOutRequest2 = testableNetworkService.getRequest(expectedUrl2);
        if (optOutRequest1 != null) {
            assertEquals(expectedUrl1, optOutRequest1.getUrl());
        } else {
            assertNotNull(optOutRequest2);
            assertEquals(expectedUrl2, optOutRequest2.getUrl());
        }
        testableNetworkService.clearCapturedRequests();
        // test
        MobileCore.lifecycleStart(null);
        // verify
        optOutRequest1 = testableNetworkService.getRequest(expectedUrl1);
        assertNull(optOutRequest1);
        optOutRequest2 = testableNetworkService.getRequest(expectedUrl2);
        assertNull(optOutRequest2);
    }

    // Test Case No : 3
    @Test
    public void
            test_Functional_Campaign_profileUpdate_VerifyProfileUpdateRetriedWhenARecoverableNetworkErrorIsEncountered()
                    throws InterruptedException {
        // setup
        ...
        String payload = new String(profileUpdateRequest.getBody());
        assertTrue(
                payload.contains(String.format(PAYLOAD_STRING, experienceCloudId, PUSH_PLATFORM)));
        testableNetworkService.clearCapturedRequests();
        testableNetworkService.setNetworkResponse(expectedUrl, "OK", 200);
    ...
    @Test
    public void
            test_Functional_Campaign_setLinkageFields_VerifyRulesDownloadRequestWithCustomHttpHeader()
                    throws InterruptedException {
        // setup
        final String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
        ...
        // verify
        testableNetworkService.waitForRequest(expectedUrl);
        final NetworkRequest rulesDownloadRequest = testableNetworkService.getRequest(expectedUrl);
    ...
    @Test
    public void
            test_Functional_Campaign_setLinkageFields_VerifyNoRulesDownloadRequest_WhenPrivacyOptOut()
                    throws InterruptedException {
        // setup
        final String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    @Test
    public void
            test_Functional_Campaign_setLinkageFields_VerifyNoRulesDownloadRequest_WhenPrivacyUnknown() {
        // test
    ...
    public void
        ...
        final HashMap<String, String> linkageFields = new HashMap<>();
        linkageFields.put("cusFirstName", FIRST_NAME);
        linkageFields.put("cusLastName", LAST_NAME);
        linkageFields.put("cusEmail", EMAIL);
        Campaign.setLinkageFields(linkageFields);
    ...
    @Test
    public void
            test_Functional_Campaign_resetLinkageFields_VerifyRulesDownloadRequestWithoutCustomHttpHeader()
                    throws InterruptedException {
        // setup
        final String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    @Test
    public void
            test_Functional_Campaign_resetLinkageFields_VerifyNoRulesDownloadRequest_WhenPrivacyOptOut()
                    throws InterruptedException {
        // setup
        final String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    @Test
    public void
            test_Functional_Campaign_resetLinkageFields_VerifyNoRulesDownloadRequest_WhenPrivacyOptUnknown()
                    throws InterruptedException {
        // test
        MobileCore.setPrivacyStatus(MobilePrivacyStatus.UNKNOWN);
        TestHelper.sleep(1000);
    ...
    public void
        ...
        NetworkRequest rulesDownloadRequest = testableNetworkService.getRequest(expectedUrl);
        assertEquals(expectedUrl, rulesDownloadRequest.getUrl());
        final Map<String, String> headers = rulesDownloadRequest.getHeaders();
        assertNotNull(headers);
        final String decodedBytes = decodeBase64(headers.get("X-InApp-Auth"));
        assertTrue(decodedBytes.contains(String.format(FIRST_NAME_FIELD, FIRST_NAME)));
        assertTrue(decodedBytes.contains(String.format(LAST_NAME_FIELD, LAST_NAME)));
    ...
    public void
        ...
        testableNetworkService.setResponseFromFile("zip/rules-broadcast.zip", expectedUrl);
        // get new MID
        final String newExperienceCloudId = getExperienceCloudId();
    ...
    public void
        ...
        final String expectedUrl =
                "https://"
                        + TestConstants.MOCK_CAMPAIGN_SERVER
                        + "/dev/rest/head/mobileAppV5/pkey_dev/subscriptions/"
                        + experienceCloudId;
        ...
        NetworkRequest profileUpdateRequest = testableNetworkService.getRequest(expectedUrl);
        assertNotNull(profileUpdateRequest);
        final String payload = new String(profileUpdateRequest.getBody());
        assertEquals(String.format(PAYLOAD_STRING, experienceCloudId, PUSH_PLATFORM), payload);
    }
    ...
    public void
        ...
        String expectedUrl =
                "https://"
                        + TestConstants.MOCK_CAMPAIGN_SERVER
                        + "/stage/rest/head/mobileAppV5/pkey_stage/subscriptions/"
                        + experienceCloudId;
    ...
    @Test
    public void
            test_Functional_Campaign_profileUpdate_WithSomeOtherEnv_VerifyProfileUpdateOnLifecycleLaunchUsesSomeOtherEnv()
                    throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
        String expectedUrl =
                "https://"
                        + TestConstants.MOCK_CAMPAIGN_SERVER
                        + "/someOtherEnv/rest/head/mobileAppV5/pkey_someOtherEnv/subscriptions/"
                        + experienceCloudId;
    ...
    @Test
    public void
            test_Functional_Campaign_InAppNotification_CheckLocalNotificationImpressionTracking()
                    throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
        String expectedUrl =
                "https://"
                        ...
                        + experienceCloudId
                        + "/rules.zip";
        String expectedTrackRequestUrl =
                "https://"
                        + TestConstants.MOCK_CAMPAIGN_SERVER
                        + "/r/?id=h153d80,b670ea,7&mcId="
                        + experienceCloudId;
        ...
        NetworkRequest messageTrackRequest =
                testableNetworkService.getRequest(expectedTrackRequestUrl);
        // verify
    ...
    // Test Case No : 17
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckLocalNotificationOpenTracking()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Test Case No : 18
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckLocalNotificationClickTracking()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Test Case No : 19
    @Test
    public void test_Functional_Campaign_PushNotification_CheckPushNotificationImpressionTracking()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Same as Test Case No : 17
    // test_Functional_Campaign_InAppNotification_CheckLocalNotificationOpenTracking

    // Test Case No : 21
    // test_Functional_Campaign_PushNotification_CheckPushNotificationClickTracking()
    // Same as Test Case No : 18
    // test_Functional_Campaign_InAppNotification_CheckLocalNotificationClickTracking

    // Test Case No : 22
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckEmptyBroadlogId()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Test Case No : 23
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckEmptyDeliveryId()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Test Case No : 24
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckEmptyAction()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Test Case No : 25
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckNullBroadlogId()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Test Case No : 26
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckNullDeliveryId()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    // Test Case No : 27
    @Test
    public void test_Functional_Campaign_InAppNotification_CheckNullAction()
            throws InterruptedException {
        // setup
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    //		String experienceCloudId = getExperienceCloudId();
    //		assertFalse(experienceCloudId.isEmpty());
    //		String expectedUrl = "https://" + TestConstants.MOCK_CAMPAIGN_SERVER + "/mcias/" +
    // TestConstants.MOCK_CAMPAIGN_SERVER + "/my_property_id/" + experienceCloudId +
    //				"/rules.zip";
    ...
    @Test
    public void
            test_Functional_Campaign_profileUpdate_VerifyProfileUpdateLifecycleLaunch_WithDefaultRegistrationDelayElapsed()
                    throws InterruptedException {
    ...
    @Test
    public void
            test_Functional_Campaign_profileUpdate_VerifyProfileUpdateOnLifecycleLaunch_WithCustomRegistrationDelayElapsed()
                    throws InterruptedException {
    ...
    public void
        ...
        // test
        MobileCore.lifecycleStart(null);
        // verify no registration request due to the 100 day custom registration delay not being
        // elapsed
        assertEquals(0, testableNetworkService.waitAndGetCount(1));
    }
    ...
    @Test
    public void
            test_Functional_Campaign_profileUpdate_VerifyNoProfileUpdateOnLifecycleLaunch_WhenRegistrationIsPaused()
                    throws InterruptedException {
        // setup, set a timestamp 31 days in the past
        String experienceCloudId = getExperienceCloudId();
        assertFalse(experienceCloudId.isEmpty());
    ...
    public void
        ...
        String expectedUrl =
                "https://"
                        ...
                        + "/rest/head/mobileAppV5/pkey/subscriptions/"
                        + experienceCloudId;
        // set registration delay to 0 which will send registration requests with every lifecycle
        // launch
    ...
    private void configurationAwareness(ConfigurationMonitor callback) {
