...
public class TestConstants {
	// Global
	static final String HERMETIC_SERVER = "sj1010006201050.corp.adobe.com";
	...
	static final String CAMPAIGN_DEV_PKEY = "__dev__campaign.pkey";
	static final String CAMPAIGN_STAGE_PKEY = "__stage__campaign.pkey";
	static final String CAMPAIGN_SERVER = "campaign.server";
	static final String CAMPAIGN_DEV_SERVER = "__dev__campaign.server";
	static final String CAMPAIGN_STAGE_SERVER = "__stage__campaign.server";
