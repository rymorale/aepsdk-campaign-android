...
public class CampaignRulesRemoteDownloaderTests extends BaseTest {

	private CampaignRulesRemoteDownloader rulesRemoteDownloader;

	private static final String DEFAULT_CACHE_DIR = "adbdownloadcache";
	private static final String RULES_CACHE_DIR = "campaignRules";
	...
	class MockProtocolHandler implements CampaignRulesRemoteDownloader.RulesBundleNetworkProtocolHandler {
		CampaignRulesRemoteDownloader.Metadata getMetadataReturn;
		@Override
		public CampaignRulesRemoteDownloader.Metadata getMetadata(File cachedBundlePath) {
	...
	class MockMetadata implements CampaignRulesRemoteDownloader.Metadata {
		...
		String getEtagReturn;
		@Override
		public String getETag() {
			return getEtagReturn;
		}
	...
	@Test
	public void getRequestParameters_When_ETagPresent_And_ProtocolHandlerIsNotNull_Then_ValidRequestParametersIsReturned()
	throws
		Exception {
		//Setup
		CacheManager cacheManager = new CacheManager(platformServices.mockSystemInfoService);
	...
	@Test
	public void
	getRequestParameters_When_WeakETagPresent_And_ProtocolHandlerIsNotNull_Then_ValidRequestParametersIsReturned()
	throws
		Exception {
		//Setup
		CacheManager cacheManager = new CacheManager(platformServices.mockSystemInfoService);
